...
# { "filetype": (parserFunc, pathlibPathToData | filepathFunc) }
...
accessorExports = {
    ...
    "dailypa": (dailyPA, paths.spl / "DAILYPA_{unit}{site}.txt"),
    "metrics": (metrics, paths.spl / "METRICS_{unit}{site}.txt")
}
